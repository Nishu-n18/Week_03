...
public class SearchTargetEfficiently {
    ...
    //  Implement Binary Search (requires to be sorted array)
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Comparing both linear search and binary search time");
        for (int N : dataset) {
